...
**Generated:** 2026-09-13 00:47:10
**Corpus:** 118 texts analyzed with GPT-2
...
| contemporary | 7 | 6.09 | 5.86 | **0.23** | 37% | 33.21 |
...
| prose_poetry | 6 | 5.22 | 5.49 | **-0.27** | 35% | 18.16 |
| surrealist | 1 | 5.90 | 6.22 | **-0.33** | 33% | 19.75 |
| control | 5 | 3.90 | 5.56 | **-1.66** | 20% | 12.11 |

### Finding
**haiku** poetry has the highest average S₂ (2.14), while **surrealist** has the lowest among poetry (-0.33).
...
|---|---|---|---|
| first_10% | 1.07 | -0.44 | 1103 |
| 10-25% | 0.59 | -0.82 | 1736 |
| 25-50% | 0.13 | -0.97 | 2900 |
| 50-75% | 0.06 | -1.06 | 2871 |
| 75-90% | 0.26 | -0.91 | 1725 |
| last_10% | -0.09 | -1.10 | 1202 |

### Line break analysis:
- Avg S₂ at newline tokens: **-1.58** (n=1081)
- Avg S₂ at tokens immediately after newline: **6.08** (n=1081)
- Avg S₂ at all other tokens: **0.46** (n=10456)

### Finding
Tokens immediately after line breaks have higher S₂ (6.08) than other positions (0.46). This suggests **enjambment is a key site of Straussian deviation** — the first word of a new line is where poets most often defy expectation.
...
- Poetry avg S₂: **0.30** (σ=0.83, n=113)
