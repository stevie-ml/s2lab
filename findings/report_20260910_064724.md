...
**Generated:** 2026-09-10 06:47:24
**Corpus:** 106 texts analyzed with GPT-2
...
|---|---|---|---|
| first_10% | 1.13 | -0.22 | 957 |
| 10-25% | 0.70 | -0.79 | 1509 |
| 25-50% | 0.19 | -0.99 | 2523 |
| 50-75% | 0.17 | -1.00 | 2496 |
| 75-90% | 0.38 | -0.86 | 1501 |
| last_10% | -0.01 | -1.10 | 1045 |

### Line break analysis:
- Avg S₂ at newline tokens: **-1.55** (n=972)
- Avg S₂ at tokens immediately after newline: **6.65** (n=972)
- Avg S₂ at all other tokens: **0.56** (n=9059)

### Finding
Tokens immediately after line breaks have higher S₂ (6.65) than other positions (0.56). This suggests **enjambment is a key site of Straussian deviation** — the first word of a new line is where poets most often defy expectation.
...
- Poetry avg S₂: **0.37** (σ=0.83, n=101)
