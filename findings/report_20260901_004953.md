...
**Generated:** 2026-09-01 00:49:53
**Corpus:** 73 texts analyzed with GPT-2
...
|---|---|---|---|
| first_10% | 0.86 | -0.28 | 519 |
| 10-25% | 1.16 | -0.70 | 834 |
| 25-50% | 0.02 | -1.10 | 1391 |
| 50-75% | -0.11 | -1.01 | 1371 |
| 75-90% | -0.13 | -1.02 | 826 |
| last_10% | -0.17 | -1.19 | 581 |

### Line break analysis:
- Avg S₂ at newline tokens: **-1.43** (n=510)
- Avg S₂ at tokens immediately after newline: **4.84** (n=510)
- Avg S₂ at all other tokens: **0.36** (n=5012)

### Finding
Tokens immediately after line breaks have higher S₂ (4.84) than other positions (0.36). This suggests **enjambment is a key site of Straussian deviation** — the first word of a new line is where poets most often defy expectation.
...
1. **Rainer Maria Rilke** — "Die erste Elegie (Eröffnung)" (S₂=1.67)
...
| POS | Poetry AvgS₂ | Prose AvgS₂ | Δ S₂ |
|-----|------------|-----------|------|
