...
- Avg S₂ at tokens immediately after newline: **5.92** (n=1726)
- Avg S₂ at all other tokens: **0.40** (n=15658)

### Finding
Tokens immediately after line breaks have higher S₂ (5.92) than other positions (0.40). This suggests **enjambment is a key site of Straussian deviation** — the first word of a new line is where poets most often defy expectation.
...
- Poetry avg S₂: **0.28** (σ=0.82, n=163)
